...
export function NotFound404() {
  ...
  return (
    <div style={{
      ...
      {/* Glow blobs */}
      <div style={{ position: 'absolute', top: '-15%', left: '-10%', width: '50vw', height: '50vw', borderRadius: '50%', background: 'radial-gradient(circle, rgba(21,128,61,0.1) 0%, transparent 70%)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: '-15%', right: '-10%', width: '45vw', height: '45vw', borderRadius: '50%', background: 'radial-gradient(circle, rgba(21,128,61,0.08) 0%, transparent 70%)', pointerEvents: 'none' }} />
      ...
      <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', maxWidth: 480, width: '100%' }}>
        ...
        {/* Heading */}
        <h1 style={{ fontSize: 26, fontWeight: 800, color: '#f0fdf4', margin: '0 0 12px', letterSpacing: '-0.02em' }}>
