      ...
      <svg viewBox={`0 0 ${W} ${H}`} style={{ width: '100%', height: 150 }} preserveAspectRatio="none">
        <defs>
          <linearGradient id="ptGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%"   stopColor="#88fc8a" stopOpacity={0.25} />
            <stop offset="100%" stopColor="#88fc8a" stopOpacity={0} />
          </linearGradient>
        </defs>
        <polygon points={area} fill="url(#ptGrad)" />
        <polyline points={line} fill="none" stroke="#88fc8a" strokeWidth="2.5" strokeLinejoin="round" strokeLinecap="round" />
...
const SLICE_COLORS = ['#4ade80', '#60a5fa', '#f59e0b', '#f87171']
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
            ...
            <tbody>
              ...
              {!loading && profitTx.map((t, i) => {
                ...
                const statusColor = t.status === 'COMPLETED' ? { color: '#4ade80', bg: 'rgba(74,222,128,0.12)' }
