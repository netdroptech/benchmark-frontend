  ...
  return (
    <div className="p-4 md:p-8 max-w-[1400px] mx-auto overflow-x-hidden">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {[
          { label: 'Total Listings',     value: String(properties.length), sub: 'Active properties',   color: '#86efac' },
          { label: 'Available Now',      value: String(available), sub: 'Ready to invest', color: '#4ade80' },
          ...
          return (
            <div
              ...
              onMouseEnter={e => {
                ...
                el.style.boxShadow = '0 12px 40px rgba(74,222,128,0.12)'
              }}
              onMouseLeave={e => {
                const el = e.currentTarget as HTMLDivElement
            ...
            >
              ...
              <div style={{ position: 'relative', height: 190, overflow: 'hidden' }}>
                ...
                <span style={{
                  ...
                  color: '#4ade80', background: 'rgba(0,0,0,0.5)',
                  backdropFilter: 'blur(6px)',
                  padding: '3px 8px', borderRadius: 6,
              ...
              <div style={{ padding: '14px 16px 16px' }}>
                ...
                {/* Price */}
                <p style={{ fontSize: 17, fontWeight: 800, color: '#4ade80', marginBottom: 8, letterSpacing: '-0.01em' }}>
                  {fmt(property.price)}
                ...
                <button
                  ...
                  style={{
                    ...
                    background: property.status === 'SOLD'
                      ...
                      : 'linear-gradient(135deg, rgba(74,222,128,0.25) 0%, rgba(74,222,128,0.15) 100%)',
                    color: property.status === 'SOLD' ? 'hsl(240 5% 45%)' : '#86efac',
