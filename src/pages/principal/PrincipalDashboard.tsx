...
function PrincipalDashboardInner() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'fixed', top: '-20%', right: '-10%', width: '50vw', height: '50vw', borderRadius: '50%', background: 'radial-gradient(circle, rgba(21,128,61,0.1) 0%, transparent 70%)', pointerEvents: 'none', zIndex: 0 }} />
      <div style={{ position: 'fixed', bottom: '-20%', left: '-10%', width: '45vw', height: '45vw', borderRadius: '50%', background: 'radial-gradient(circle, rgba(21,128,61,0.08) 0%, transparent 70%)', pointerEvents: 'none', zIndex: 0 }} />
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 11, color: 'rgba(134,239,172,0.6)', margin: 0 }}>Super-level control</p>
            </div>
          </div>
          ...
          {!isMobile && (
            <div style={{
              ...
              <div style={{ flex: 1, padding: '20px 12px' }}>
                {[
                  { key: 'branding', icon: <Image size={16} style={{ color: '#4ade80', flexShrink: 0 }} />, label: 'Branding', sub: 'Logo, name & favicon' },
                  { key: 'security', icon: <ShieldCheck size={16} style={{ color: '#4ade80', flexShrink: 0 }} />, label: 'Security', sub: 'Credentials & access' },
                  { key: 'settings', icon: <Settings size={16} style={{ color: '#4ade80', flexShrink: 0 }} />, label: 'Settings', sub: 'Domain, email & integrations' },
                ].map(item => (
                  <button key={item.key} onClick={() => setActivePage(item.key as any)} style={{
                    ...
                    borderLeft: activePage === item.key ? '3px solid #4ade80' : '3px solid transparent',
              ...
              <>
                ...
                <div style={{
                  ...
                  <div style={{ padding: '20px 28px', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', gap: 10 }}>
                    <Image size={16} style={{ color: '#4ade80' }} />
                  ...
                  <div style={{ padding: 28 }}>
                    <div style={{ marginBottom: 28 }}>
                      ...
                      <div style={{
                        ...
                        {isCustomLogo && (
                          <span style={{ fontSize: 10, fontWeight: 700, color: '#4ade80', background: 'rgba(74,222,128,0.1)', border: '1px solid rgba(74,222,128,0.25)', padding: '3px 8px', borderRadius: 999, letterSpacing: '0.06em' }}>CUSTOM</span>
                        )}
                      </div>
                      {isCustomLogo && (
                        <button
                    ...
                    <div style={{ marginBottom: 24 }}>
                      ...
                      <div
                        ...
                        style={{
                          border: `2px dashed ${dragging ? 'rgba(74,222,128,0.6)' : 'rgba(255,255,255,0.1)'}`,
                          borderRadius: 14,
                          padding: '32px 24px',
                          textAlign: 'center',
                          cursor: 'pointer',
                          background: dragging ? 'rgba(74,222,128,0.04)' : 'rgba(255,255,255,0.01)',
                          transition: 'all 0.2s',
                        }}
                      >
                    ...
                    {logoSuccess && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '11px 14px', borderRadius: 10, background: 'rgba(74,222,128,0.07)', border: '1px solid rgba(74,222,128,0.2)', marginBottom: 20 }}>
                        <CheckCircle size={13} style={{ color: '#4ade80', flexShrink: 0 }} />
                        <p style={{ fontSize: 12, color: '#86efac', fontWeight: 500, margin: 0 }}>Logo updated successfully across the entire platform!</p>
                      </div>
                    )}
                    ...
                    <button
                      ...
                      style={{
                        ...
                        height: 48,
                        borderRadius: 12,
                        background: preview ? 'linear-gradient(135deg, #16a34a 0%, #15803d 100%)' : 'rgba(255,255,255,0.04)',
                        border: preview ? 'none' : '1px solid rgba(255,255,255,0.07)',
                        color: preview ? '#fff' : 'hsl(240 5% 38%)',
                        fontSize: 14,
                        fontWeight: 700,
                        cursor: preview ? 'pointer' : 'not-allowed',
                        boxShadow: preview ? '0 8px 24px rgba(21,128,61,0.35)' : 'none',
                        transition: 'all 0.2s',
                      }}
                    >
                      <CheckCircle size={16} />
                ...
                <div style={{
                  ...
                  <div style={{ padding: '20px 28px', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', gap: 10 }}>
                    <Type size={16} style={{ color: '#4ade80' }} />
                  ...
                  <div style={{ padding: 28 }}>
                    <div style={{ marginBottom: 24 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                        <div style={{
                          ...
                          {isCustomName && (
                            <span style={{ fontSize: 10, fontWeight: 700, color: '#4ade80', background: 'rgba(74,222,128,0.1)', border: '1px solid rgba(74,222,128,0.25)', padding: '3px 8px', borderRadius: 999, letterSpacing: '0.06em', marginLeft: 'auto' }}>CUSTOM</span>
                          )}
                        </div>
                        <button
                          onClick={() => setNameEditing(e => !e)}
                          style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '10px 16px', borderRadius: 10, background: nameEditing ? 'rgba(74,222,128,0.1)' : 'rgba(255,255,255,0.04)', border: `1px solid ${nameEditing ? 'rgba(74,222,128,0.3)' : 'rgba(255,255,255,0.07)'}`, color: nameEditing ? '#4ade80' : 'hsl(40 6% 70%)', fontSize: 12, fontWeight: 600, cursor: 'pointer', whiteSpace: 'nowrap' }}
                        >
                          <Pencil size={12} />
                        ...
                        <div style={{ display: 'flex', gap: 10 }}>
                          ...
                          <button
                            ...
                            style={{
                              ...
                              background: (nameInput.trim() && nameInput.trim() !== platformName) ? 'linear-gradient(135deg, #16a34a, #15803d)' : 'rgba(255,255,255,0.04)',
                              border: 'none',
                              ...
                              boxShadow: (nameInput.trim() && nameInput.trim() !== platformName) ? '0 6px 18px rgba(21,128,61,0.3)' : 'none',
                    ...
                    {nameSuccess && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '11px 14px', borderRadius: 10, background: 'rgba(74,222,128,0.07)', border: '1px solid rgba(74,222,128,0.2)', marginTop: 12 }}>
                        <CheckCircle size={13} style={{ color: '#4ade80', flexShrink: 0 }} />
                        <p style={{ fontSize: 12, color: '#86efac', fontWeight: 500, margin: 0 }}>Platform name updated across the entire platform!</p>
                      </div>
                    )}
                  </div>
                </div>
                  ...
                  <div style={{ padding: 28 }}>
                    <div style={{ marginBottom: 28 }}>
                      ...
                      <div style={{
                        ...
                        {isCustomFavicon && (
                          <span style={{ fontSize: 10, fontWeight: 700, color: '#4ade80', background: 'rgba(74,222,128,0.1)', border: '1px solid rgba(74,222,128,0.25)', padding: '3px 8px', borderRadius: 999, letterSpacing: '0.06em', marginLeft: 4 }}>CUSTOM</span>
                        )}
                      </div>
                      {isCustomFavicon && (
                        <button
                    ...
                    <div style={{ marginBottom: 24 }}>
                      ...
                      <div
                        ...
                        style={{
                          border: `2px dashed ${faviconDragging ? 'rgba(74,222,128,0.6)' : 'rgba(255,255,255,0.1)'}`,
                          borderRadius: 14,
                          padding: '28px 24px',
                          textAlign: 'center',
                          cursor: 'pointer',
                          background: faviconDragging ? 'rgba(74,222,128,0.04)' : 'rgba(255,255,255,0.01)',
                          transition: 'all 0.2s',
                        }}
                      >
                    ...
                    {faviconSuccess && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '11px 14px', borderRadius: 10, background: 'rgba(74,222,128,0.07)', border: '1px solid rgba(74,222,128,0.2)', marginBottom: 20 }}>
                        <CheckCircle size={13} style={{ color: '#4ade80', flexShrink: 0 }} />
                        <p style={{ fontSize: 12, color: '#86efac', fontWeight: 500, margin: 0 }}>Favicon updated! Check your browser tab.</p>
                      </div>
                    )}
                    ...
                    <button
                      ...
                      style={{
                        ...
                        height: 48,
                        borderRadius: 12,
                        background: faviconPreview ? 'linear-gradient(135deg, #16a34a 0%, #15803d 100%)' : 'rgba(255,255,255,0.04)',
                        ...
                        boxShadow: faviconPreview ? '0 8px 24px rgba(21,128,61,0.35)' : 'none',
                        transition: 'all 0.2s',
                      }}
                    >
                      <CheckCircle size={16} />
            ...
            {activePage === 'security' && (
              <>
                  ...
                  <div style={{ padding: 28 }}>
                    <div style={{ marginBottom: 24, padding: '18px 20px', borderRadius: 14, background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 14 }}>
                        <User size={13} style={{ color: '#86efac' }} />
                        <p style={{ fontSize: 11, fontWeight: 700, color: '#86efac', letterSpacing: '0.07em', textTransform: 'uppercase', margin: 0 }}>Current Admin Account</p>
                      ...
                      <div style={{ marginBottom: 12 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                          ...
                          {savedCreds?.email && (
                            <button onClick={() => copyCredField('email', savedCreds.email)} style={{ flexShrink: 0, height: 36, paddingInline: 12, borderRadius: 8, background: copiedField === 'email' ? 'rgba(74,222,128,0.12)' : 'rgba(255,255,255,0.06)', border: `1px solid ${copiedField === 'email' ? 'rgba(74,222,128,0.3)' : 'rgba(255,255,255,0.1)'}`, color: copiedField === 'email' ? '#4ade80' : 'hsl(240 5% 55%)', fontSize: 11, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 5, transition: 'all 0.2s' }}>
                    ...
                    {adminSuccess && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '11px 14px', borderRadius: 10, background: 'rgba(74,222,128,0.07)', border: '1px solid rgba(74,222,128,0.2)', marginBottom: 16 }}>
                        <CheckCircle size={13} style={{ color: '#4ade80', flexShrink: 0 }} />
                        <p style={{ fontSize: 12, color: '#86efac', fontWeight: 500, margin: 0 }}>{adminSuccess}</p>
                      </div>
                    )}
                ...
                <div style={{
                  ...
                  {authCodeSaved && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '9px 13px', borderRadius: 9, background: 'rgba(74,222,128,0.07)', border: '1px solid rgba(74,222,128,0.2)', marginBottom: 14 }}>
                      <CheckCircle size={13} style={{ color: '#4ade80' }} />
                      <p style={{ fontSize: 12, color: '#4ade80', fontWeight: 600, margin: 0 }}>Auth code saved successfully.</p>
                    </div>
                  )}
                  ...
                  {authCode && (
                    <div style={{ padding: '12px 14px', borderRadius: 11, background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                        ...
                        <button
                          onClick={copyAuthUrl}
                          style={{ height: 28, paddingInline: 10, borderRadius: 7, background: authCodeCopied ? 'rgba(74,222,128,0.12)' : 'rgba(255,255,255,0.06)', border: `1px solid ${authCodeCopied ? 'rgba(74,222,128,0.3)' : 'rgba(255,255,255,0.1)'}`, color: authCodeCopied ? '#4ade80' : 'hsl(240 5% 55%)', fontSize: 11, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 5, transition: 'all 0.2s' }}>
              ...
              <>
                ...
                <div style={{
                  ...
                  <div style={{ padding: 28 }}>
                    ...
                    <div style={{ marginBottom: 24 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                        <div style={{
                          ...
                          {isCustomDomain && (
                            <span style={{ fontSize: 10, fontWeight: 700, color: '#4ade80', background: 'rgba(74,222,128,0.1)', border: '1px solid rgba(74,222,128,0.25)', padding: '3px 8px', borderRadius: 999, letterSpacing: '0.06em', marginLeft: 'auto', flexShrink: 0 }}>CUSTOM</span>
                          )}
                        </div>
                        <button
                          onClick={() => { setDomainEditing(e => !e); setDomainError('') }}
                          style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '10px 16px', borderRadius: 10, background: domainEditing ? 'rgba(74,222,128,0.1)' : 'rgba(255,255,255,0.04)', border: `1px solid ${domainEditing ? 'rgba(74,222,128,0.3)' : 'rgba(255,255,255,0.07)'}`, color: domainEditing ? '#4ade80' : 'hsl(40 6% 70%)', fontSize: 12, fontWeight: 600, cursor: 'pointer', whiteSpace: 'nowrap', flexShrink: 0 }}
                        >
                          <Pencil size={12} />
                      ...
                      <div style={{ marginBottom: 4 }}>
                        ...
                        <div style={{ display: 'flex', gap: 10 }}>
                          <div style={{ position: 'relative', flex: 1 }}>
                            ...
                            <input
                              ...
                              style={{
                                ...
                                background: 'rgba(255,255,255,0.04)',
                                border: `1px solid ${domainError ? 'rgba(248,113,113,0.45)' : 'rgba(74,222,128,0.35)'}`,
                                color: 'hsl(40 6% 92%)', outline: 'none', boxSizing: 'border-box',
                              }}
                              autoFocus
                            />
                          ...
                          <button
                            ...
                            style={{
                              height: 46, padding: '0 20px', borderRadius: 11,
                              background: domainInput.trim() ? 'linear-gradient(135deg, #16a34a, #15803d)' : 'rgba(255,255,255,0.04)',
                              border: 'none',
                    ...
                    {domainSuccess && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '11px 14px', borderRadius: 10, background: 'rgba(74,222,128,0.07)', border: '1px solid rgba(74,222,128,0.2)', marginTop: 12 }}>
                        <CheckCircle size={13} style={{ color: '#4ade80', flexShrink: 0 }} />
                        <p style={{ fontSize: 12, color: '#86efac', fontWeight: 500, margin: 0 }}>Domain updated successfully!</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ padding: 28 }}>
                    <div style={{ marginBottom: 24 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                        ...
                        <button
                          ...
                          style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '10px 16px', borderRadius: 10, background: emailEditing ? 'rgba(74,222,128,0.1)' : 'rgba(255,255,255,0.04)', border: `1px solid ${emailEditing ? 'rgba(74,222,128,0.3)' : 'rgba(255,255,255,0.07)'}`, color: emailEditing ? '#4ade80' : 'hsl(40 6% 70%)', fontSize: 12, fontWeight: 600, cursor: 'pointer', whiteSpace: 'nowrap', flexShrink: 0 }}
                        >
                          <Pencil size={12} />
                      ...
                      <div style={{ marginBottom: 4 }}>
                        ...
                        <div style={{ display: 'flex', gap: 10 }}>
                          <div style={{ position: 'relative', flex: 1 }}>
                            ...
                            <input
                              ...
                              style={{
                                ...
                                background: 'rgba(255,255,255,0.04)',
                                border: `1px solid ${emailError ? 'rgba(248,113,113,0.45)' : 'rgba(74,222,128,0.35)'}`,
                                color: 'hsl(40 6% 92%)', outline: 'none', boxSizing: 'border-box',
                              }}
                              autoFocus
                            />
                          ...
                          <button
                            ...
                            style={{
                              height: 46, padding: '0 20px', borderRadius: 11,
                              background: (emailInput.trim() && emailInput.trim() !== platformEmail) ? 'linear-gradient(135deg, #16a34a, #15803d)' : 'rgba(255,255,255,0.04)',
                              border: 'none',
                    ...
                    {emailSuccess && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '11px 14px', borderRadius: 10, background: 'rgba(74,222,128,0.07)', border: '1px solid rgba(74,222,128,0.2)', marginTop: 12 }}>
                        <CheckCircle size={13} style={{ color: '#4ade80', flexShrink: 0 }} />
                        <p style={{ fontSize: 12, color: '#86efac', fontWeight: 500, margin: 0 }}>Support email updated across the entire platform!</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ padding: '20px 28px', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    {liveChatScript && (
                      <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, padding: '4px 12px', borderRadius: 999, background: 'rgba(74,222,128,0.08)', border: '1px solid rgba(74,222,128,0.22)' }}>
                        <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#4ade80', animation: 'pdBlink 1.8s ease-in-out infinite' }} />
                        <span style={{ fontSize: 11, fontWeight: 700, color: '#86efac', letterSpacing: '0.05em' }}>ACTIVE</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div style={{ padding: 28 }}>
                    ...
                    <div style={{ marginBottom: 16, position: 'relative' }}>
                      ...
                      <textarea
                        ...
                        style={{
                          ...
                          border: `1px solid ${chatDirty ? 'rgba(74,222,128,0.35)' : 'rgba(255,255,255,0.08)'}`,
                        ...
                        onFocus={e => { if (!chatDirty) e.target.style.borderColor = 'rgba(74,222,128,0.35)' }}
                    ...
                    {chatSuccess && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '11px 14px', borderRadius: 10, background: 'rgba(74,222,128,0.07)', border: '1px solid rgba(74,222,128,0.2)', marginBottom: 16 }}>
                        <CheckCircle size={13} style={{ color: '#4ade80', flexShrink: 0 }} />
                        <p style={{ fontSize: 12, color: '#86efac', fontWeight: 500, margin: 0 }}>Live chat script is now active on all non-admin pages!</p>
                      </div>
                    )}
                    ...
                    <div style={{ display: 'flex', gap: 10 }}>
                      <button
                        ...
                        style={{
                          ...
                          background: (chatInput.trim() && chatDirty) ? 'linear-gradient(135deg, #16a34a 0%, #15803d 100%)' : 'rgba(255,255,255,0.04)',
                          border: 'none',
                          color: (chatInput.trim() && chatDirty) ? '#fff' : 'hsl(240 5% 38%)',
                          fontSize: 13, fontWeight: 700,
                          cursor: (chatInput.trim() && chatDirty) ? 'pointer' : 'not-allowed',
                          display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7,
                          boxShadow: (chatInput.trim() && chatDirty) ? '0 6px 18px rgba(21,128,61,0.3)' : 'none',
                          transition: 'all 0.2s',
                        }}
                      >
                        <CheckCircle size={14} />
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: active ? '#4ade80' : 'hsl(240 5% 45%)',
                ...
                >
                  {active && (
                    <div style={{
                      ...
                      width: 32, height: 2, background: '#4ade80', borderRadius: 2,
                    }} />
                  )}
                  {item.icon}
