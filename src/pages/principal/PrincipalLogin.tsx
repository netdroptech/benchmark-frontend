...
export function PrincipalLogin() {
  ...
  return (
    <div style={{
      ...
      {/* Gold glow blobs */}
      <div style={{ position: 'absolute', top: '-20%', right: '-10%', width: '55vw', height: '55vw', borderRadius: '50%', background: 'radial-gradient(circle, rgba(21,128,61,0.1) 0%, transparent 70%)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: '-20%', left: '-10%', width: '48vw', height: '48vw', borderRadius: '50%', background: 'radial-gradient(circle, rgba(21,128,61,0.08) 0%, transparent 70%)', pointerEvents: 'none' }} />
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 28 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '8px 18px', borderRadius: 999, background: 'rgba(74,222,128,0.08)', border: '1px solid rgba(74,222,128,0.2)', backdropFilter: 'blur(10px)' }}>
            <Crown size={12} style={{ color: '#4ade80' }} />
            <span style={{ fontSize: 11, fontWeight: 700, color: '#86efac', letterSpacing: '0.1em' }}>PRINCIPAL ACCESS</span>
          </div>
        </div>
        ...
        <div style={{
          ...
          {/* Header */}
          <div style={{
            background: 'linear-gradient(135deg, rgba(21,128,61,0.22), rgba(21,128,61,0.18))',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 12, color: 'rgba(134,239,172,0.7)', marginTop: 2 }}>Super-level platform control</p>
              </div>
            </div>
          </div>
          ...
          <div style={{ padding: '26px 32px 30px' }}>
            ...
            {!loading ? (
              ...
              <div style={{ textAlign: 'center', padding: '24px 0 8px' }}>
                <div style={{ width: 56, height: 56, borderRadius: '50%', background: 'linear-gradient(135deg, #16a34a, #15803d)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', boxShadow: '0 0 36px rgba(21,128,61,0.5)', animation: 'pSpinGlow 1s linear infinite' }}>
                  <Crown size={22} style={{ color: '#fff' }} />
                </div>
                ...
                <div style={{ height: 3, borderRadius: 999, background: 'rgba(255,255,255,0.06)', overflow: 'hidden' }}>
                  <div style={{ height: '100%', background: 'linear-gradient(90deg, #16a34a, #4ade80)', borderRadius: 999, animation: 'pProgressFill 1.1s ease forwards' }} />
                </div>
              </div>
            )}
          </div>
