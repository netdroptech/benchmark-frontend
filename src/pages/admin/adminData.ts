...
export const MOCK_USERS: AdminUser[] = [
  { id: 'u001', name: 'Edwin Okafor',      email: 'netdroptech@gmail.com', phone: '+234 801 234 5678', country: 'Nigeria',      flag: '🇳🇬', initials: 'EO', color: '#4ade80', balance: 14820.50, totalDeposits: 22000, totalWithdrawals: 9500, totalProfit: 2320.50,  status: 'active',    kycStatus: 'verified',    plan: 'Premium',  joinDate: '2025-08-14', lastSeen: 'Active now',  referrals: 3  },
