...
export const MOCK_USERS: AdminUser[] = [
  { id: 'u001', name: 'John Doe',      email: 'netdroptech@gmail.com', phone: '+234 801 234 5678', country: 'Nigeria',      flag: '🇳🇬', initials: 'JD', color: '#4ade80', balance: 14820.50, totalDeposits: 22000, totalWithdrawals: 9500, totalProfit: 2320.50,  status: 'active',    kycStatus: 'verified',    plan: 'Premium',  joinDate: '2025-08-14', lastSeen: 'Active now',  referrals: 3  },
...
export const MOCK_TRANSACTIONS: AdminTransaction[] = [
  ...
  { id: 'tx002', userId: 'u001', userName: 'John Doe',     userEmail: 'netdroptech@gmail.com', type: 'deposit',    amount: 2000,   status: 'completed',  method: 'USDT (TRC20)', date: '2026-03-31 11:05', reference: 'DEP-8820', },
  ...
  { id: 'tx009', userId: 'u001', userName: 'John Doe',     userEmail: 'netdroptech@gmail.com', type: 'bonus',      amount: 100,    status: 'completed',  method: 'Platform',      date: '2026-03-30 12:00', reference: 'BON-0045', note: 'Welcome bonus' },
