...
function HeroSection() {
  ...
  return (
    <section className="relative w-full overflow-hidden pt-6 pb-24 sm:pb-32">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] pointer-events-none" style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(136,252,138,0.08) 0%, transparent 70%)' }} />
      <Navbar />
          ...
          <div className="relative flex flex-col gap-4">
            <div className="liquid-glass rounded-3xl p-7 sm:p-8">
              ...
              <div className="flex items-center gap-3 mt-5 sm:mt-6 pt-5 sm:pt-6 border-t border-border/40">
                <div className="w-9 h-9 rounded-full bg-secondary flex items-center justify-center text-sm font-semibold text-foreground/80" style={{ background: 'rgba(74,222,128,0.15)', color: '#4ade80' }}>AC</div>
                <div>
              ...
              <Reveal key={member.id || member.name} delay={i * 80}>
                <div className="liquid-glass rounded-3xl p-5 sm:p-6 flex flex-col gap-3 sm:gap-4 hover:bg-white/[0.03] transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm mt-0.5" style={{ color: '#88fc8a' }}>{member.role}</p>
                  </div>
                  {member.bio && (
