  ...
  return (
    <div style={{ minHeight: '100vh', background: 'hsl(260 87% 3%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 'clamp(0px, 3vw, 24px) clamp(0px, 4vw, 16px)', fontFamily: "'Geist Sans','Inter',system-ui,sans-serif", position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none' }}>
        ...
        <div style={{ position: 'absolute', bottom: '-15%', right: '-5%', width: 500, height: 500, borderRadius: '50%', background: 'radial-gradient(circle, rgba(74,222,128,0.05) 0%, transparent 70%)', filter: 'blur(60px)' }} />
              ...
              <div key={i} style={{ display: 'flex', gap: 16, alignItems: 'stretch' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0, width: 32 }}>
                  <div style={{
                    ...
                    background: s.done ? 'rgba(74,222,128,0.15)' : s.active ? 'rgba(245,158,11,0.15)' : 'rgba(255,255,255,0.04)',
                    border: `1px solid ${s.done ? 'rgba(74,222,128,0.35)' : s.active ? 'rgba(245,158,11,0.35)' : 'rgba(255,255,255,0.08)'}`,
                    color: s.done ? '#4ade80' : s.active ? '#fbbf24' : 'hsl(240 5% 40%)',
                  ...
                  {i < steps.length - 1 && (
                    <div style={{ width: 1, flex: 1, margin: '4px 0', background: s.done ? 'rgba(74,222,128,0.25)' : 'rgba(255,255,255,0.06)' }} />
                  )}
                </div>
                ...
                <div style={{ paddingBottom: i < steps.length - 1 ? 20 : 0, paddingTop: 4, flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 2 }}>
                    ...
                    {s.done && (
                      <span style={{ fontSize: 10, fontWeight: 700, padding: '2px 8px', borderRadius: 999, background: 'rgba(74,222,128,0.1)', color: '#4ade80', border: '1px solid rgba(74,222,128,0.2)', letterSpacing: '0.04em' }}>
                        DONE
                      </span>
                    )}
                  </div>
