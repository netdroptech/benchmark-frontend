        ...
        <div style={{
          ...
          {stage === 'sent' && (
            <div className="text-center py-4">
              ...
              <p className="text-sm font-semibold mb-6" style={{ color: '#4ade80' }}>
                {email}
              </p>
              ...
              <p className="text-xs mb-5" style={{ color: 'hsl(240 5% 50%)' }}>
                ...
                <button
                  ...
                  style={{ background: 'none', border: 'none', cursor: resent ? 'default' : 'pointer', color: '#4ade80', padding: 0, fontSize: 'inherit' }}
                >
