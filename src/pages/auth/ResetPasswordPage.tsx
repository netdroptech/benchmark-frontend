      ...
      <div className="text-center py-4">
        <div className="relative w-20 h-20 mx-auto mb-6">
          <div
            ...
            style={{ background: 'rgba(34,197,94,0.1)', animation: 'ringPulse 2s ease-in-out infinite' }}
          />
          <div
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              style={{
                background: 'rgba(255,255,255,0.05)',
                border: `1px solid ${confirmPw && confirmPw !== password ? 'rgba(239,68,68,0.4)' : confirmPw && confirmPw === password ? 'rgba(34,197,94,0.4)' : 'rgba(255,255,255,0.1)'}`,
                color: 'hsl(40 6% 90%)',
              }}
              onFocus={e => (e.currentTarget.style.borderColor = 'rgba(34,197,94,0.45)')}
              onBlur={e  => {
          ...
          {rules.map((r, i) => (
            <div key={i} className="flex items-center gap-2.5">
              <div
                ...
                style={{
                  background: r.ok ? 'rgba(34,197,94,0.2)' : 'rgba(255,255,255,0.05)',
                  border: `1px solid ${r.ok ? 'rgba(34,197,94,0.5)' : 'rgba(255,255,255,0.1)'}`,
                }}
              >
                {r.ok && (
              ...
              <span className="text-xs transition-colors" style={{ color: r.ok ? '#86efac' : 'hsl(240 5% 48%)' }}>
                {r.label}
              </span>
            </div>
          ))}
