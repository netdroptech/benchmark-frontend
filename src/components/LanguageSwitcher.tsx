            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((lang, i) => {
                ...
                return (
                  ...
                  >
                    <span style={{ flex: 1, fontSize: 12.5, fontWeight: isSelected ? 600 : 400, color: isSelected ? '#86efac' : 'hsl(40 6% 78%)' }}>
                      {lang.name}
                    </span>
                    {isSelected && <Check size={13} style={{ color: '#4ade80', flexShrink: 0 }} />}
                  </button>
                )
              })
            )}
